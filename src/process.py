...
ANCHOR_CLASSES = {POLE, TRAFFIC_LIGHT, TRAFFIC_SIGN}
INVALID_PLACEMENT_CLASSES = {ROAD, SKY, *DYNAMIC_CLASSES}
...
MIN_BBOX_EDGE = 12
MIN_BBOX_AREA = 16 * 16
MAX_OBJECT_FRACTION = 0.22
HARD_MASK_THRESHOLD = 0.5
MOTION_BLUR_PROB = 0.16
MOTION_BLUR_KERNEL_SIZES = (3, 5)
MOTION_BLUR_MAX_ANGLE = 12.0
